...
public class Paycoins {
	...
	public Result<String> execute(@Param(name="type", defaultValue="1") Integer type,
    	...
    	return Result.newInstance(payStatus.getDesc(), payStatus.getDesc(), payStatus.getSuccess());
	}
}
