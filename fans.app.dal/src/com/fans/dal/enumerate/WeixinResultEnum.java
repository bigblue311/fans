...
public enum WeixinResultEnum {
	...
	private WeixinResultEnum(String code,String desc, String reason, String resolve){
		this.code = code;
		this.desc = desc;
		this.reason = reason;
	...
	public static List<WeixinResultEnum> getAll(){
		return Lists.newArrayList(WeixinResultEnum.values());
	}
	
	public static WeixinResultEnum get(String code){
		for(WeixinResultEnum extensionEnum : getAll()){
			if(extensionEnum.getCode().equals(code)){
